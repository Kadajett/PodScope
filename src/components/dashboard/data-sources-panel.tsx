      ...
      <div className="space-y-4 pr-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Cluster API connection</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Metrics and monitoring data</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium">Status</span>
        ...
        {dataSources?.data.victoriaMetrics && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Alternative metrics storage</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">URL</span>
        ...
        {dataSources?.data.grafana && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Dashboard integration</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium">Status</span>
