...
function EventCountBadges({ eventCounts, totalEvents }: EventCountBadgesProps) {
  return (
...
function EventItem({ event, index, onClick }: EventItemProps) {
        ...
        {showHeader && (
          <div className="flex items-center justify-between px-6 py-3 border-b bg-background">
            <div className="flex items-center gap-4">
              ...
              <EventCountBadges eventCounts={eventCounts} totalEvents={events.length} />
            </div>
          </div>
        )}
