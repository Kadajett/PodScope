...
import { mockHealthResponses, mockDataSourcesResponses } from "../fixtures/mock-responses";
...
export class ApiMocker {
	...
	async mockHealthCheck(
		scenario: keyof typeof mockHealthResponses = "healthy",
	) {
	 ...
	 */
	async mockDataSources(
		scenario: keyof typeof mockDataSourcesResponses = "healthy",
	) {
...
export class StorageHelper {
	 ...
	 */
	async setDashboardConfig(config: {
		layouts?: unknown;
		components?: unknown;
		queries?: unknown;
	}) {
				...
				try {
					return {
						...
						components: JSON.parse(
							localStorage.getItem("dashboard-components") || "[]",
						),
